kaboom({
  ...
  loadSprite("bossIdle", "./assets/sprites/demon/demon_Idle_Left.png", {
      sliceY: 6,
      // Define animations
      anims: {
          "bossIdle": {
  ...
  loadSprite("bossIdleRight", "./assets/sprites/demon/demon_Idle_Right.png", {
      sliceY: 6,
      // Define animations
      anims: {
          "bossIdleRight": {
  ...
  loadSprite("bossWalk", "./assets/sprites/demon/demon_walk_left.png", {
      sliceY: 12,
      // Define animations
      anims: {
          "bossWalk": {
  ...
  loadSprite("bossWalkRight", "./assets/sprites/demon/demon_walk_right.png", {
      sliceY: 12,
      // Define animations
      anims: {
          "bossWalkRight": {
  ...
  loadSprite("bossAttack1", "./assets/sprites/demon/demon_attak_left.png", {
      sliceY: 15,
      // Define animations
      anims: {
          "bossAttack1": {
  ...
  loadSprite("bossAttack1Right", "./assets/sprites/demon/demon_attak_right.png", {
      sliceY: 15,
      // Define animations
      anims: {
          "bossAttack1Right": {
  ...
  enemy2.onStateEnter("attack", () => {
    ...
    //   enemy2.origin = "botright";
      ...
      if (getRandomInt(1, 1) == 1) {
        ...
        enemy2.area.width = 140;
        //console.log("attack");
        enemy2.play("bossAttack1", {
          // any additional arguments will be passed into the onStateEnter() callback
          onEnd: () => enemy2.enterState("idle", rand(0.5, 0.5)),
        });
      } else {
  ...
  enemy2.onStateUpdate("move", () => {
    ...
    if (p.isGrounded()) {
      ...
      if (enemy2.pos.dist(p.pos) < getRandomInt(250,280)) {
          console.log("POSE / "+enemy2.pos.dist(p.pos));
